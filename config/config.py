...
VERTEX_AI_REGION = get_env_variable("VERTEX_AI_REGION", "us-central1") # Example default
...
GEMINI_MODEL_NAME = get_env_variable("GEMINI_MODEL_NAME", "gemini-1.5-flash-001") # Updated default
...
def log_startup_config_check():
    ...
    logging.debug(f"GCP Project: {GCP_PROJECT_ID}, Vertex Region: {VERTEX_AI_REGION}")
